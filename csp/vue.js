...
function protoAugment (target, src) {
  //localStorage.setItem('test',target)
...
function queueWatcher (watcher) {
  ...
  if (has$1[id] == null) {
    ...
    if (!flushing) {
      queue.push(watcher);
      //console.log(queue)
        //localStorage.setItem('queuewatcher',queue.toString());
    } else {
...
function Vue$3 (options) {
  ...
  //console.log(this.constructor.options);
    //localStorage.setItem('init_options',JSON.stringify(this.constructor.options));
...
function initGlobalAPI (Vue) {
  ...
  configDef.get = function () {
   // console.log('configdefget');
    return config; };
  {
    configDef.set = function (x) {
     //   console.log('configdefset');
  ...
  Vue.options = Object.create(null);
   // localStorage.setItem('test',JSON.stringify(Vue.options));
  config._assetTypes.forEach(function (type) {
...
function createPatchFunction (backend) {//console.log(backend);
  var i, j;
  var cbs = {};
...
//console.log(arguments);
    ...
    if (isDef(tag)) {
     ...
     // localStorage.setItem('test',vnode.elm)
  ...
  function patchVnode (oldVnode, vnode, insertedVnodeQueue, removeOnly) {
    ...
    } else if (oldVnode.text !== vnode.text) {//console.log(vnode.text,oldVnode.text,nodeOps);
  ...
  return function patch (oldVnode, vnode, hydrating, removeOnly, parentElm, refElm) {//console.log(oldVnode,vnode)
    if (!vnode) {
...
//gdb();
    ...
    if (!oldVnode) {
      ...
      if (!isRealElement && sameVnode(oldVnode, vnode)) {//console.log(isRealElement)
